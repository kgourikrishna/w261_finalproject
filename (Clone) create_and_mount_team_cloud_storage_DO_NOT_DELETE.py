...
secret_scope    = "team_2_1_scope_2"           # The name of the scope created in your local computer using the Databricks CLI
secret_key      = "team_2_1_key_2"             # The name of the secret key created in your local computer using the Databricks CLI
